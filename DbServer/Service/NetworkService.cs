...
public class NetworkService : BackgroundService {
    public static IDbContextFactory<AlloyContext>
        ContextFactory; // Don't yell at me this is the closest to the correct way I could do
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken) {
        ...
        while (!stoppingToken.IsCancellationRequested) {
            ...
            Console.WriteLine(
                $"Connected: {await context.Database.CanConnectAsync(stoppingToken)} | Connection count: {Listener.AppConnections.Count}");
    ...
    private void NetworkHealthMonitor() {
        ...
        foreach (var key in remove) Listener.AppConnections.Remove(key);
    }
}
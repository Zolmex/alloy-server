...
public class Account : DbModel, IDbQueryable {
    ...
    public static readonly Account Guest = new() {
        ...
        AccStats = new AccountStat {
            ...
            TotalCredits = (uint)NewAccountsConfig.Config.Credits, CurrentFame = (uint)NewAccountsConfig.Config.Fame,
    ...
    public Account() {
        ...
        RegisterProperty("GuildMember",
            ...
            (ref rdr) => {
                GuildMember = Read<GuildMember>(ref rdr);
        ...
        RegisterProperty("AccountSkins",
            ...
            (ref rdr) => {
                ...
                for (var i = 0; i < count; i++) {
                    var skin = Read<AccountSkin>(ref rdr);
                    if (skin != null)
        ...
        RegisterProperty("AccountIgnores",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var ign = Read<AccountIgnore>(ref rdr);
                    if (ign != null)
        ...
        RegisterProperty("AccountLocks",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var locks = Read<AccountLock>(ref rdr);
                    if (locks != null)
        ...
        RegisterProperty("Characters",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var chr = Read<Character>(ref rdr);
                    if (chr != null)
                        Characters.Add(chr);
                }
            }
        ...
        RegisterProperty("AccountVaults",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var vault = Read<AccountVault>(ref rdr);
                    if (vault != null)
        ...
        RegisterProperty("AccountGifts",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var gift = Read<AccountGift>(ref rdr);
                    if (gift != null)
        ...
        RegisterProperty("AccountMutes",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var mute = Read<AccountMute>(ref rdr);
                    if (mute != null)
        ...
        RegisterProperty("AccountBans",
            ...
            (ref rdr) => {
                ...
                var count = rdr.ReadInt16();
                for (var i = 0; i < count; i++) {
                    var ban = Read<AccountBan>(ref rdr);
                    if (ban != null)
                        AccountBans.Add(ban);
                }
            }

...
import kabam.rotmg.game.view.components.statsview.assets.StatAssets;
...
public class WebMain extends Sprite {
    ...
    public static var UIParser:TextureParser;
    ...
    private function setup():void {
        ...
        var constellationData:XML = ConstellationsData.XMLData;
        ConstellationsDataStore.getInstance().loadConstellationsDataFromXML(constellationData);

        var statAssets:XML = StatAssets.XMLData;
        StatAssetsManager.getInstance().parse(new StatAssetsSheet().bitmapData, statAssets);
    }
    ...
    private function createContext():void {
        ...
        UIParser = TextureParser.instance;
    }
}
}

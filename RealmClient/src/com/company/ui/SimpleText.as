...
import com.company.ui.fonts.BeaufortPro;
import com.company.ui.fonts.BeaufortProBold;
import com.company.ui.fonts.Spiegel;
import com.company.ui.fonts.SpiegelBold;
import com.company.ui.fonts.SpiegelBoldCFF;
...
public class SimpleText extends TextField {
    ...
    public static const _BeaufortPro:Class = BeaufortPro;
    public static const _BeaufortProBold:Class = BeaufortProBold;
    public static const _Spiegel:Class = Spiegel;
    public static const _SpiegelBold:Class = SpiegelBold;
    public static const _SpiegelBoldCFF:Class = SpiegelBoldCFF;
    ...
    public function SimpleText(textSize:int, color:uint, makeSelectable:Boolean = false, widthParam:int = 0, heightParam:int = 0, isLink:Boolean = false, fontName:String = null) {
        if (!_FontRegistered) {
            Font.registerFont(_BeaufortPro);
            Font.registerFont(_BeaufortProBold);
            Font.registerFont(_Spiegel);
            Font.registerFont(_SpiegelBold);
            Font.registerFont(_SpiegelBoldCFF);
            _Font = new _BeaufortPro();
        ...
        format.font = fontName || _Font.fontName;
        format.bold = false;
    ...
    public function setFont(fontName:String):SimpleText {
        var format:TextFormat = defaultTextFormat;

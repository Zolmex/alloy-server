...
public class AssetLibrary {
    ...
    public static function addImageSet(name:String, dataClass:Class, width:int, height:int):void {
        var data:BitmapData;
        if (dataClass != null) {
            data = new dataClass().bitmapData as BitmapData;
        } else if (name == "invisible") {
            data = new BitmapData(8, 8, true, 0);
        } else {
            trace("Failed to create sprite sheet", name);
            return;
        }

...
import com.company.util.CachingColorTransformer;
   ...
   public class SavedCharacter
   {
      ...
      public static function getImage(savedChar:SavedCharacter, playerXML:XML, dir:int, action:int, p:Number, selected:Boolean, dimmed:Boolean, size:int = 100, normal:Boolean = false) : BitmapData
      {
      ...
      {
         return int(this.charXML_.Experience);
      }
      
      public function fame() : int
      {
         return int(this.charXML_.CharFame);
      }

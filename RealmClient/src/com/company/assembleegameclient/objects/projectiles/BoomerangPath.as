...
public class BoomerangPath extends ProjectilePathSegment
{
    public function BoomerangPath()
    {
        super(BOOMERANG_PATH);
    }
    ...
    {
        var path:BoomerangPath = FreeList.newObject(BoomerangPath) as BoomerangPath;

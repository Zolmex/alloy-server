package com.company.assembleegameclient.objects.particles
{
   ...
   public class ThrowEffect extends ParticleEffect
   {
      ...
      public function ThrowEffect(start:Point, end:Point, color:int, lifetime:int)
      {
         super();
         this.start_ = start;
         this.end_ = end;
      ...
      override public function update(time:int, dt:int) : Boolean
      {
         ...
         y_ = this.start_.y;
         var size:int = 200;
         var part:ThrowParticle = new ThrowParticle(size,this.color_,this.lifetime_,this.start_,this.end_);

...
public class BasicObject
   {
      ...
      public var posW_:Vector.<Number>; // World position
      public var posS_:Vector.<Number>; // Screen position
      ...
      public function computeSortVal(camera:Camera) : void
      {
         ...
         this.posS_.length = 0;
         camera.wToS_.transformVectors(this.posW_,this.posS_); // Convert world position to screen position and save to posS_

package com.company.assembleegameclient.objects
{
   ...
   public class ObjectProperties
   {
      ...
      public var noInterpolation:Boolean;
      public var interpolationAmount:int;
      ...
      public function ObjectProperties(objectXML:XML)
      {
         ...
         this.noInterpolation = objectXML.hasOwnProperty("NoInterpolation");
         this.interpolationAmount = int(objectXML.InterpolationAmount);
         if (this.interpolationAmount == 0){
            this.interpolationAmount = 100;
         }
      }

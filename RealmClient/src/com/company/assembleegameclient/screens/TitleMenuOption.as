package com.company.assembleegameclient.screens
{
   ...
   public class TitleMenuOption extends Sprite
   {
      ...
      private var lower:Boolean;
      
      public function TitleMenuOption(text:String, size:int, pulse:Boolean, color:uint = 0xffffff, lower:Boolean = true)
      {
         super();
         this.size = size;
         this.color = color;
      ...
      public function setText(text:String) : void
      {
         ...
         this.textField = new SimpleText(this.size,color,false,0,0);
         this.textField.setBold(true);
         this.textField.text = lower ? text.toLowerCase() : text;

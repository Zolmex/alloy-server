...
public class AccountScreen extends Sprite {
    ...
    private var rankTooltip:RankToolTip;
    ...
    public function setRank(stars:int, accRank:int):void {
        this.stars = stars;
    ...
    private function makeRankText():void {
        this.rankText = new RankText(this.stars, this.accRank, true, false);
        this.rankText.x = 36;
        this.rankText.y = 4;
    ...
    protected function onMouseOver(event:MouseEvent):void {
        this.rankTooltip = new RankToolTip(this.stars);
        stage.addChild(this.rankTooltip);
    }

    protected function onRollOut(event:MouseEvent):void {
        stage.removeChild(this.rankTooltip);
    }
}
}

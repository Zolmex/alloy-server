...
public class ToolTip extends Sprite {
    ...
    public var followMouse_:Boolean;
    ...
    public var stayInStage:Boolean;

    private var leftTarget:Boolean;
    ...
    protected function setStayInStage(val:Boolean):void {
        this.stayInStage = val;
        if (val) {
            return;
        }
    ...
    public function attachToTarget(dObj:DisplayObject):void {
        if (dObj) {
            ...
            this.targetObj.addEventListener(MouseEvent.ROLL_OVER, this.onEnterTarget);
        }
    }
    ...
    public function detachFromTarget():void {
        ...
        if (this.targetObj) {
            ...
            this.targetObj.removeEventListener(MouseEvent.ROLL_OVER, this.onEnterTarget);
            if (parent) {
    ...
    private function onEnterTarget(e:MouseEvent):void {
    ...
    private function fixScale():void {
        ...
        this.scaleX = scaleW / (scaleW / scaleH);
        this.scaleY = scaleH;
    }

...
public class CompactDamageCounterView extends Sprite implements IDamageCounterView {
    private var map:Map;

    private var enemyInfo:DamageCounterEnemyRect;

    private var rankingRects:Vector.<CompactDamageCounterRankingRect> = new Vector.<CompactDamageCounterRankingRect>();

    public function CompactDamageCounterView(map:Map) {
        this.map = map;
    ...
    private function addRanking() : void {
        ...
        for (var i:int = 0; i < 5; i++) {
            var rankingRect:CompactDamageCounterRankingRect = new CompactDamageCounterRankingRect();
            rankingRect.y = y;
    ...
    public function dispose():void {
        ...
        for each (var rect:CompactDamageCounterRankingRect in rankingRects)
            rect.dispose();

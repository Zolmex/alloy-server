...
public class Stats extends Sprite {
    ...
    public function draw(player:Player):void {
        this.stats_[ATTACK].draw(player.attack);
        this.stats_[DEFENSE].draw(player.defense);
        this.stats_[DEXTERITY].draw(player.dexterity);
        this.stats_[WISDOM].draw(player.wisdom);
    }

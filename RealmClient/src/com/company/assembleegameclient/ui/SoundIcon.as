...
import com.company.assembleegameclient.sound.SFX;
   ...
   public class SoundIcon extends Sprite
   {
      ...
      {
         this.bitmap_.bitmapData = Parameters.data_.playMusic ? AssetLibrary.getImageFromSet("lofiInterfaceBig",3):AssetLibrary.getImageFromSet("lofiInterfaceBig",4);
      }
      
      private function onIconClick(event:MouseEvent) : void
      {
         var value:Boolean = !Parameters.data_.playMusic;
         SFX.setPlaySFX(value);
         Parameters.data_.playMusic = value;
         Parameters.data_.playPewPew = value;
         Parameters.data_.playSFX = value;
         Parameters.save();
         MusicPlayer.switchOnOff();
         this.setBitmap();
      }
   }
}

package com.company.assembleegameclient.ui
{
   ...
   {
      private static var FONT_DESCRIPTION:String = "SpiegelBoldCFF";
      ...
      public var partyTextFormat:ElementFormat = null;
      public var partyNameFormat:ElementFormat = null;
      ...
      public function ElementFormats()
      {
         ...
         this.partyTextFormat = this.newDefaultFormat();
         this.partyTextFormat.color = 14127351;
         this.partyNameFormat = this.newDefaultFormat();
         this.partyNameFormat.color = 9522377;

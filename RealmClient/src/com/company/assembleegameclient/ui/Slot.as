...
import com.company.assembleegameclient.itemData.ItemDataField;
...
public class Slot extends Sprite {
    ...
    private var itemSprite:ItemTileSprite;
    private var tooltip:EquipmentToolTip;
    public var itemInvId:int;
    public var slotId:int;

    public function Slot(slotId:int, type:int, hotkey:int, cuts:Array, isInteractive:Boolean) {
    ...
    private function onMouseOver(e:Event):void {
        ...
        this.tooltip = new EquipmentToolTip(this.getItemData());
    ...
    private function endDrag(e:MouseEvent):void {
        ...
        dispatchEvent(new ItemTileEvent(ItemTileEvent.ITEM_MOVE, null, this));
    }
    ...
    public function setItem(item:ItemData, itemInvId:int):Boolean {
    ...
    public virtual function canHoldItem(type:int):Boolean {
        return true;
    }
    ...
    protected function drawBackground():void {
        ...
        GraphicsUtil.drawCutEdgeRectGraphics(0, 0, WIDTH, HEIGHT, 4, this.cuts_, g);
        g.lineStyle();
    }
}
}

...
import kabam.rotmg.emote.Emote;
...
public class TextBoxLine {
    ...
    public function getTextBlock():TextBlock {
        ...
        else if (recipient_ == Parameters.PARTY_CHAT_NAME) {
            textFormat = ELEMENT_FORMATS.partyTextFormat;
            nameFormat = ELEMENT_FORMATS.partyNameFormat;
        }
   ...
   private static function containsEmotes(text:String):Boolean {

...
public class ConditionEffect {
    ...
    public static const SHEATHE_STANCE:uint = 61;
    ...
    public static const SHEATHE_STANCE_BIT:uint = 1 << (SHEATHE_STANCE - NEW_CON_THREASHOLD);
    ...
    public static var effects_:Vector.<ConditionEffect> = new <ConditionEffect>[
        ...
        new ConditionEffect("Mana Deplete", MANA_DEPLETE_BIT, [0x3e]),
        new ConditionEffect("Sheathe Stance", SHEATHE_STANCE_BIT, null),
    ];

package com.company.assembleegameclient.engine3d
{
   ...
   public class TextureMatrix
   {
      ...
      public function calculateUVMatrix(uvt:Vector.<Number>):void {
         ...
         var texWidth:Number = this.texture_.width;
         var texHeight:Number = this.texture_.height;

         var i:int = uvt.length - 3;
         var tx:Number = uvt[0] * texWidth;
         var ty:Number = uvt[1] * texHeight;
         this.uvMatrix_.a = uvt[3] * texWidth - tx;
         this.uvMatrix_.b = uvt[4] * texHeight - ty;
         this.uvMatrix_.c = uvt[i] * texWidth - tx;
         this.uvMatrix_.d = uvt[i + 1] * texHeight - ty;

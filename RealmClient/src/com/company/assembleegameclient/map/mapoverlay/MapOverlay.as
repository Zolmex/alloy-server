...
import flash.display.Sprite;
   ...
   public class MapOverlay extends Sprite
   {
      ...
      public var abilityOverlay:AbilityGuideOverlay;
      ...
      public function addAbilityGuideOverlay(player:Player):void {
         this.abilityOverlay = new AbilityGuideOverlay(player);
         addChild(this.abilityOverlay);
      }

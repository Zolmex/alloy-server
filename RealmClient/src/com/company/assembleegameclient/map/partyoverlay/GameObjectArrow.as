...
public class GameObjectArrow extends Sprite {
    ...
    public function correctQuestNote(camera:Camera):Rectangle {
        ...
        this.scaleX = 1 / mscale;
        this.scaleY = 1 / mscale;
        if (this.tooltip_) {
            this.tooltip_.scaleX = scaleW / (scaleW / scaleH);
            this.tooltip_.scaleY = scaleH;
        }
        clipRect.right -= (WebMain.sWidth - this.go_.map_.gs_.hudView.x) / mscale;
        return clipRect;
    }
    ...
    public function draw(time:int, camera:Camera):void {
        ...
        var clipRect:Rectangle = this.correctQuestNote(camera);

...
public class Map extends Sprite {
    ...
    public var merchLookup_:Dictionary;
    ...
    public function Map(gs:GameSprite) {
        ...
        this.merchLookup_ = new Dictionary();
    ...
    public function setProps(width:int, height:int, name:String, back:int, allowPlayerTeleport:Boolean, showDisplays:Boolean, music:String, difficulty:int):void {
        this.width_ = width;
        this.height_ = height;
        this.name_ = name;
        this.back_ = back;
    ...
    public function draw(camera:Camera, time:int):void {
        ...
        if (stage.scaleMode == StageScaleMode.NO_SCALE) {
            if (isGpuRender) {
                x = (-screenRect.x * 800) / (800 / Parameters.data_.mscale);
                y = (-screenRect.y * 600) / (600 / Parameters.data_.mscale);
            } else {
                x = (-screenRect.x * 800) / (800 / Parameters.data_.mscale);
                y = (-screenRect.y * 600) / (600 / Parameters.data_.mscale);
            }

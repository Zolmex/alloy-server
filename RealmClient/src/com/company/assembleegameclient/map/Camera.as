...
public class Camera {
   ...
   public static var STATS_SCREEN_RECT:Rectangle = new Rectangle(-400, -325, 600, 600);
   public static var STATS_OFFSET_SCREEN_RECT:Rectangle = new Rectangle(-400, -450, 600, 600);
   ...
   public static function resizeCamera():void {
      ...
      STATS_SCREEN_RECT = new Rectangle(-scaleW / 2, -scaleH * 13 / 24, scaleW, scaleH);
      STATS_OFFSET_SCREEN_RECT = new Rectangle(-scaleW / 2, -scaleH * 3 / 4, scaleW, scaleH);
   }

   public function configureCamera(go:GameObject):void {
      var rect:Rectangle = Parameters.data_.centerOnPlayer ? Parameters.data_.statsViewOpen ? STATS_SCREEN_RECT : CENTER_SCREEN_RECT
              : Parameters.data_.statsViewOpen ? STATS_OFFSET_SCREEN_RECT : OFFSET_SCREEN_RECT;

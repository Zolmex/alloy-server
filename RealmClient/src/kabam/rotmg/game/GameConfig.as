...
import kabam.rotmg.game.view.components.constellationstab.ConstellationsRightTabMediator;
import kabam.rotmg.game.view.components.statsview.left.AllStatsMediator;
import kabam.rotmg.game.view.components.statsview.left.AllStatsView;
import kabam.rotmg.game.view.components.statsview.StatMediator;
   import kabam.rotmg.game.view.components.statsview.StatView;
   import kabam.rotmg.game.view.components.statsview.right.StatsMediator;
...
import kabam.rotmg.ui.model.TabStripModel;
   ...
   public class GameConfig implements IConfig
   {
      ...
      private function generalGameConfiguration() : void
      {
         ...
         this.mediatorMap.map(ConstellationsRightTab).toMediator(ConstellationsRightTabMediator);
         this.mediatorMap.map(AllStatsView).toMediator(AllStatsMediator);

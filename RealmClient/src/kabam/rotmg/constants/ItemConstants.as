...
public class ItemConstants {
    ...
    public static function isEquippable(slotType:int):Boolean {
        var typeName:String = ItemConstants.itemTypeToName(slotType);
        return typeName != "Invalid Type!" && typeName != "Potion";
    }

    public static function isDecimalProperty(stat:String):Boolean { // Stats that are stored as floating points like rate of fire 1.0 = 100%
        switch (stat) {
            case "RateOfFire":
                return true;
            default:

...
public class NewEditorScreen extends Sprite {
    ...
    private function onAddedToStage(e:Event):void {
        ...
        this.editorView.addEventListener(RealmEditorTestEvent.TEST_CONNECT, this.onMapTest);
    ...
    private function onMapTest(e:RealmEditorTestEvent):void {
        ...
        this.gameSprite = new GameSprite(this.server, Parameters.TEST_GAMEID, false, this.model.getSavedCharacters()[0].charId(), this.model, e.mapJSON_);

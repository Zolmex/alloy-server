...
public class TitleMediator extends Mediator {
    ...
    override public function initialize():void {
        ...
        this.view.optionsClicked.add(this.showOptionsScreen);
    }
    ...
    override public function destroy():void {
        ...
        this.view.optionsClicked.remove(this.showOptionsScreen);
    }
    ...
    private function showOptionsScreen():void {
        this.setScreen.dispatch(new Options(null, this.setScreen));
    }
}
}

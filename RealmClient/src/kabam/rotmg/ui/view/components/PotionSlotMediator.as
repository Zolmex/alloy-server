...
import com.company.assembleegameclient.ui.panels.itemgrids.itemtiles.InteractiveItemTile;
   ...
   public class PotionSlotMediator extends Mediator
   {
      ...
      private function onDrop(targetDO:DisplayObject) : void
      {
         ...
         {
            GameServerConnection.instance.invDrop(player,PotionInventoryModel.getPotionSlot(this.view.objectType));
         }
         else if(target is InteractiveItemTile)
         {
            ...
            {
               GameServerConnection.instance.invSwapPotion(player,player,PotionInventoryModel.getPotionSlot(this.view.objectType), this.view.objectType,tile.ownerGrid.owner,tile.tileId);
            }
         }
      }

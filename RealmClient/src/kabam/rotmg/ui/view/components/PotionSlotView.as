...
import org.osflash.signals.Signal;
   ...
   public class PotionSlotView extends Sprite
   {
      ...
      public function PotionSlotView(bgTexture:String, position:int)
      {
         ...
         this.text = new SimpleText(14,16777215,false,BUTTON_HEIGHT,BUTTON_WIDTH);
         this.text.setBold(true);
         this.text.filters = [new DropShadowFilter(0,0,0,1,4,4,2)];
         this.text.y = 0;
         this.bg = TextureParser.instance.getTexture("UI", bgTexture);
         addChild(this.bg);
         addChild(this.text);

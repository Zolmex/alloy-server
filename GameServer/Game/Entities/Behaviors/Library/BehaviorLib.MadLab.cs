...
public partial class BehaviorLib {
    ...
    public static State TurretAttack =>
        new(
            ...
            new State("shoot",
                new Shoot(15,
                    new ProjectilePath(4000, PathSegment.NewLine(4)),
                    2,
                    180,
                    fixedAngle: 90,
    ...
    public static State MiniBot =>
        new(
            new State("p1",
                new Wander(4F),
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(4)),
                    2,
                    45,
    ...
    public static State RampageCyborg =>
        new(
            ...
            new State("shoot",
                ...
                new Wander(3F),
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(6)),
                    predictive: 1,
            ...
            new State("explode",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(8)),
                    10,
                    36,
    ...
    public static State EscapedExperiment =>
        new(
            new State("p1",
                new Wander(4F),
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(3.5F)),
    ...
    public static State EnforcerBot3000 =>
        new(
            new State("p1",
                new Wander(3F),
                new Shoot(15,
                    new ProjectilePath(1000, PathSegment.NewChangeSpeed(3, -1F, 400, repeat: 2)),
                    3,
                    15,
                    ...
                    damage: 120),
                new Shoot(15,
                    new ProjectilePath(2500, PathSegment.NewLine(5F)),
                    3,
                    20,
    ...
    public static State CrusherAbomination =>
        new(
            new State("p1",
                new Wander(4F),
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(5F)),
                    3,
                    15,
                    size: 100,
            ...
            new State("p2",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(5.5F)),
                    3,
                    size: 150,
                    shootAngle: 15,
                    projName: "Shockwave Blast",
            ...
            new State("p3",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(6F)),
                    3,
                    size: 175,
                    shootAngle: 15,
                    projName: "Shockwave Blast",
            ...
            new State("p4",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(6.5F)),
                    3,
                    size: 200,
                    shootAngle: 15,
                    projName: "Shockwave Blast",
    ...
    public static State LabTurret =>
        new(
            ...
            new State("shoot",
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewAmplitude(4, 1.5F, 1.2F)),
                    2,
                    size: 60,
                    shootAngle: 15,
                    projName: "Science Fire Ball",
    ...
    public static State RedGasSpawnerUL =>
        new(
            ...
            new State("GAS!",
                new Shoot(15,
                    new ProjectilePath(12000, PathSegment.NewLine(2)),
                    10,
                    size: 80,
                    shootAngle: 36,
                    rotateAngle: 10,
    ...
    public static State DrTerrible =>
        new(
            ...
            new State("p1",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewChangeSpeed(3, 1, 1000)),
                    3,
                    size: 130,
                    shootAngle: 15,
            ...
            new State("p2",
                ...
                new Follow(3, 1),
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewLine(5))
                        .Then(1000, PathSegment.NewAmplitude(-1, 2, 0.3F))
                        .Then(3000, PathSegment.NewLine(-5)),
                    8,
                    size: 150,
                    shootAngle: 45,
                    projName: "Yellow Energy Shot",
                    ...
                    damage: 100),
                new Shoot(15,
                    new ProjectilePath(1500, PathSegment.NewLine(7))
                        .Then(500, PathSegment.NewAmplitude(-1, 2, 0.3F))
                        .Then(1500, PathSegment.NewLine(-7)),
                    4,
                    size: 130,
                    shootAngle: 20,
                    projName: "Purple Energy Shot",
    ...
    public static State HorrificCreation =>
        new(
            ...
            new State("p1",
                ...
                new Shoot(15,
                    new ProjectilePath(3000, PathSegment.NewChangeSpeed(7, 1.5F, 500)),
                    20,
                    size: 175,
                    shootAngle: 18,
            ...
            new State("p2",
                ...
                new Shoot(15,
                    ...
                    damage: 150),
                new Shoot(15,
                    new ProjectilePath(200, PathSegment.NewLine(9))
                        .Then(200, PathSegment.NewLine(-9)),
                    10,
                    size: 100,
                    shootAngle: 36,
                    ...
                    damage: 150),
                new Shoot(15,
                    new ProjectilePath(9000, PathSegment.NewChangeSpeed(10, -2, 1000)),
                    20,
                    size: 100,
                    shootAngle: 18,

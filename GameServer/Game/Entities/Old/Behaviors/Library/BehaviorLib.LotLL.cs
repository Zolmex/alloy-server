    ...
    public static State LordOfTheLostLands =>
        new(
            ...
            new State("Start1.0",
                ...
                new State("Gathering1.0",
                    ...
                    new State("Gathering1.1",
                        new Shoot(30, 4, 360 / 4f, fixedAngle: 90, projectilePropsId: 1,
                            cooldownMS: 1200),
                        new TimedTransition(1500, "Gathering1.2")
                    ),
                    new State("Gathering1.2",
                        new Shoot(30, 4, 360 / 4f, fixedAngle: 45, projectilePropsId: 1,
                            cooldownMS: 1000),
            ...
            new State("Suicide",
                ...
                new Shoot(12, 8, 360 / 8f, fixedAngle: 360 / 8f, projectilePropsId: 1, cooldownMS: 1000),
                new Suicide()
            )
        );
    ...
    public static State GuardianOfTheLostLands =>
        new(
            ...
            new State("Full",
                ...
                new Shoot(10, 8, 360 / 8f, fixedAngle: 360 / 8f, cooldownMS: 1300, projectilePropsId: 1),
            ...
            new State("Low",
                ...
                new Shoot(10, 8, 360 / 8f, fixedAngle: 360 / 8f, cooldownMS: 3000, projectilePropsId: 1),

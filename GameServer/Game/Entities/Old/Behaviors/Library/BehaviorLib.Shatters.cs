...
public partial class BehaviorLib {
    ...
    public static State ShtrsBridgeSentinel =>
        new(
            // new ScaleHP2(35),
            new Shoot(2, projectilePropsId: 5, count: 3, fixedAngle: 90, cooldownMS: 500),
            new Shoot(2, projectilePropsId: 5, count: 3, fixedAngle: 45 + 90, cooldownMS: 500),
            new Shoot(2, projectilePropsId: 5, count: 3, fixedAngle: 90 + 90, cooldownMS: 500),
            new Shoot(2, projectilePropsId: 5, count: 3, fixedAngle: 135 + 90, cooldownMS: 500),
            new Shoot(2, projectilePropsId: 5, count: 3, fixedAngle: 180 + 90, cooldownMS: 500),
    ...
    public static State ShtrsBridgeObeliskB =>
        new(
            ...
            new State("Shoot",
                new ConditionEffectBehavior(ConditionEffectIndex.Invulnerable),
                new Shoot(projectilePropsId: 0, maxRadius: 10, count: 4, shootAngle: 90, fixedAngle: 0, cooldownMS: 200),
                new TimedTransition(10000, "Pause")
            ),
            new State("Pause",
                new ConditionEffectBehavior(ConditionEffectIndex.Invulnerable, 0),
    ...
    public static State ShtrsBridgeObeliskF =>
        new(
            ...
            new State("Shoot",
                new ConditionEffectBehavior(ConditionEffectIndex.Invulnerable),
                new Shoot(10, projectilePropsId: 0, count: 4, shootAngle: 90, fixedAngle: 0, cooldownMS: 200),
                new TimedTransition(10000, "Pause")
            ),
            new State("Pause",
                new ConditionEffectBehavior(ConditionEffectIndex.Armored),
    ...
    public static State ShtrsArchmageOfFlame =>
        new(
            ...
            new State("Fire",
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 45, fixedAngle: 45, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 90, fixedAngle: 90, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 135, fixedAngle: 135, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 180, fixedAngle: 180, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 225, fixedAngle: 225, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 270, fixedAngle: 270, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 315, fixedAngle: 315, cooldownMS: 170,
                    coolDownOffset: 0),
                new Shoot(0, projectilePropsId: 0, count: 1, shootAngle: 360, fixedAngle: 360, cooldownMS: 170,
                    coolDownOffset: 0),
                new TimedTransition(5000, "wait")
            )
        );
    ...
    public static State ShtrsFirebomb =>
        new(
            ...
            new State("Explode",
                new ConditionEffectBehavior(ConditionEffectIndex.Invincible),
                new Shoot(100, shootAngle: 360 / 8f, projectilePropsId: 0, count: 8, targeted: false,
                    cooldownMS: 1000),
                new Suicide()
            )
        );

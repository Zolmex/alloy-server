    ...
    public static State VengefulSpirit =>
        new(
            new State("Start",
                ...
                new Shoot(8.4f, 3, projectilePropsId: 0, shootAngle: 16, cooldownMS: 800, targeted: true),
                new TimedTransition(1000, "Vengeful")
            ),
            new State("Vengeful",
                new Follow(0.5f * 5.55f + 0.74f, 8, 1),
                new Wander(0.3f * 5.55f + 0.74f),
                new Shoot(8.4f, 3, projectilePropsId: 0, shootAngle: 16, cooldownMS: 1245, targeted: true),
                new TimedTransition(3000, "Vengeful2")
            ),
            new State("Vengeful2",
                new ReturnToSpawn(1 * 5.55f + 0.74f),
                new Shoot(8.4f, 3, projectilePropsId: 0, shootAngle: 16, cooldownMS: 750, targeted: true),
    ...
    public static State BeachSpectre =>
        new(
            new State("Fight",
                ...
                new Shoot(8.4f, 3, projectilePropsId: 0, shootAngle: 14, cooldownMS: 1250, targeted: true)
            )
        );
        ...
        new(
            ...
            new State("start",
                ...
                new State("2",
                    ...
                    new Shoot(12, projectilePropsId: 0, cooldownMS: 450, targeted: true),
                    new Shoot(12, 3, projectilePropsId: 0, shootAngle: 20, cooldownMS: 1050, targeted: true),
            ...
            new State("midfight",
                ...
                new State("midfight2",
                    ...
                    new Shoot(8.4f, projectilePropsId: 1, cooldownMS: 1250, targeted: true),
                ...
                new State("midfight1",
                    ...
                    new Shoot(8.4f, 6, projectilePropsId: 0, shootAngle: 10, cooldownMS: 950, targeted: true),
            ...
            new State("countdown",
                ...
                new Shoot(8.4f, projectilePropsId: 0, cooldownMS: 450, targeted: true),
                new Shoot(8.4f, 5, projectilePropsId: 0, shootAngle: 20, cooldownMS: 750, targeted: true),
            ...
            new State("fire",
                ...
                new Shoot(8.4f, 10, projectilePropsId: 0, cooldownMS: 1300, targeted: true),

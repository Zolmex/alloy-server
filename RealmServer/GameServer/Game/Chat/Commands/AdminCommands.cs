    ...
    public override void Execute(Player player, string args)
    {
        ...
        switch (command)
        {
            case "name":
                ...
                player.SendInfo("Sent a restore by name command to DbServer.");
                return;
            ...
            case "before":
                ...
                ServerControl.Publish(ControlChannel.DbRestore, ServerControl.Host.InstanceID, null, message);
                player.SendInfo("Sent a restore before date/time command to DbServer.");
                return;
...
public class DbBackupCommand : Command
{
    public override void Execute(Player player, string args)
    {
        ...
        player.SendInfo("Sent a backup command to DbServer.");
    }
}
...
public class DbWipeCommand : Command
{
    public override void Execute(Player player, string args)
    {
        ...
        player.SendInfo("Sent a wipe command to DbServer.");
    }
}
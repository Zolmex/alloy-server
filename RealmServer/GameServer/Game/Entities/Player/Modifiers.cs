...
public class RisingFury : Modifier
{
    ...
    public void InCombat()
    {
        ...
        _player.Stacks.AddStack(ModStacks.Fury, -1);
...
public class DelightfulHarvest : Modifier
{
    ...
    {
        return Math.Max((int)(val * (Math.Min(1f + (14f * (time / 60000f)), 15f) / 100f)), 1);
    }
}
...
public class BloodReaper : Modifier
{
    ...
    public void OnEnemyHit(Character hit, DamageSource damageSource)
    {
        ...
        if (Hits == 3)
        {
            _player.Stacks.AddStack(ModStacks.BloodReaper, 5000);
            Hits = 0;
        }
    }
...
public class SoulReaper : Modifier
{
    ...
    public void OnEnemyHit(Character hit, DamageSource damageSource)
    {
        ...
        if (Hits == 3)
        {
            _player.Stacks.AddStack(ModStacks.SoulReaper, 5000);
            Hits = 0;
        }
...
public class MindReaper : Modifier
{
    ...
    public void OnEnemyHit(Character hit, DamageSource damageSource)
    {
        ...
        if (Hits == 3)
        {
            _player.Stacks.AddStack(ModStacks.MindReaper, 5000);
            Hits = 0;
        }
    }

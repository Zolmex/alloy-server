    ...
    public partial class Player
    {
        ...
        public void TradeRequest(string name)
        {
            ...
            if (PotentialPartner == null || !PotentialPartner.Equals(partner))
            {
                ...
                TradeRequested.Write(partner.User.Network, Name);
            ...
            else
            {
                ...
                TradeStart.Write(User.Network, myItems, theirItems, partner.Name);
                TradeStart.Write(partner.User.Network, theirItems, myItems, Name);
            }
        }
        ...
        public void AcceptTrade(bool[] myOffer, bool[] theirOffer)
        {
            ...
            if (TradePartner.Trade.SequenceEqual(theirOffer))
            {
                ...
                TradeAccepted.Write(TradePartner.User.Network, theirOffer, myOffer);
        ...
        public void ChangeTrade(bool[] newOffer)
        {
            ...
            TradeChanged.Write(TradePartner.User.Network, Trade);
            if (triedSoulbound)
            {
        ...
        {
            TradeDone.Write(User.Network, result);
            if (TradePartner != null)
                TradeDone.Write(TradePartner.User.Network, result);
            ResetTrade();
        }

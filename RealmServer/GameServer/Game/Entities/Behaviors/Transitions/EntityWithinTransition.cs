...
namespace GameServer.Game.Entities.Behaviors.Transitions
{
    ...
    public class EntityWithinTransition : BehaviorTransition
    {
        ...
        public EntityWithinTransition(string targetState, string target = "player", float radius = 8f, TransitionType transitionType = TransitionType.Random)
            : base(transitionType)
        {
        ...
        public EntityWithinTransition(string target = "player", float radius = 8f, TransitionType transitionType = TransitionType.Random, params string[] targetStates)
            : base(transitionType)
        {

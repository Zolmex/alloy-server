...
public partial class BehaviorLib
{
    ...
    public static State TombT =>
        new(
            new State("open",
                new ConditionEffectBehavior(ConditionEffectIndex.Invincible, persist: true),
                new Suicide(100),
                new RemoveObjectOnDeath("Tomb Wall Break", 15)
            )
        );
    ...
    public static State TombPuzzle =>
        new(
            ...
            new State("Start",
                new Taunt("Stand on the middle tile to begin the puzzle!", 10000),
                new EntityWithinTransition(target: "player", radius: 1, targetState: "spawn")
            ),
            new State("spawn",
                new Taunt("Press 4 plates in the correct sequence!", 10000),
            ...
            new State("FAIL1",
                new Taunt("The vault rejects the unworthy!", 1000000),
                new TimedTransition(1000, "FAIL2")
            ),
            new State("FAIL2",
                new Taunt("Return when the ancient order is known to you!", 1000000)
            ),
            new State("OPEN",
            ...
            new State("3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(200, TransitionType.Random, "1left", "1right"),
                new EntityWithinTransition(target: "TombWrong", radius: 20, targetState: "1mistake")
            ),
            new State("1left",
            ...
            new State("1gg",
                new Taunt("4/4! You may access the ancient vault!", 10000),
            ...
            new State("2-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "2bot", "2right")
            ),
            new State("2bot",
            ...
            new State("3-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "3up", "3bot")
            ),
            new State("3bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("2/1-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "2/1bot", "2/1right")
            ),
            new State("2/1bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("3/1-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "3/1up", "3/1bot")
            ),
            new State("3/1bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("3/1/2-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "3/1/2up", "3/1/2bot")
            ),
            new State("3/1/2bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("2/1/3-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "2/1/3bot", "2/1/3right")
            ),
            new State("2/1/3bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("1/2-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "1/2left", "1/2right")
            ),
            new State("1/2left",
                new Spawn("TombPATLEFT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("3/2-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "3/2up", "3/2bot")
            ),
            new State("3/2bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
                new TimedTransition(500, "pat3/1-idle4")
            ...
            new State("3/2/1-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "3/2/1up", "3/2/1bot")
            ),
            new State("3/2/1bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("1/2/3-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "1/2/3left", "1/2/3right")
            ),
            new State("1/2/3left",
                new Spawn("TombPATLEFT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("1/3-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "1/3left", "1/3right")
            ),
            new State("1/3left",
                new Spawn("TombPATLEFT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("2/3-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "2/3bot", "2/3right")
            ),
            new State("2/3bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("2/3/1-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "2/3/1bot", "2/3/1right")
            ),
            new State("2/3/1bot",
                new Spawn("TombPATBOT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),
            ...
            new State("1/3/2-3/4",
                new Taunt("3/4!", 10000),
                new TimedTransition(500, TransitionType.Random, "1/3/2left", "1/3/2right")
            ),
            new State("1/3/2left",
                new Spawn("TombPATLEFT", cooldownMs: 100000, maxDensity: 1, densityRadius: 10),

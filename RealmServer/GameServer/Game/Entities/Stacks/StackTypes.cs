    ...
    public override void OnTick(RealmTime time)
    {
        if (Player.TimeSinceLastEnemyHit > TimeSinceHit)
        {
            ...
            if (Timer >= TimeBetweenStacks)
            {
                ...
                _controller.PendingStacks.Add(new PendingStack(ModStacks.Onslaught)); //duration is left at 0 meaning a stack is being removed
...
public class UntouchedStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.Untouched, 1);
    }
...
public class DesecratedStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.Desecrated, 1);
...
public class MachinationsStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.Machinations, 1000);
    }
...
public class BloodReaperStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.BloodReaper, 1000);
    }
...
public class SoulReaperStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.SoulReaper, 1000);
    }
...
public class MindReaperStack : Stack
{
    ...
    {
        Player = owner as Player;
        InitStack(ModStacks.MindReaper, 1000);

...
public static class DbKeys
{
    ...
    public const string GuildNames = "guildNames";
    public const string NextGuildId = "nextGuildId";
    public const string NextPartyId = "nextPartyId";
    public const string KeepOnWipe = "keepOnWipe";
}
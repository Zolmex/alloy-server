...
{
    private static readonly HttpClient _apiClient = new() { BaseAddress = baseAddress };

    private static readonly Uri baseAddress = new($"https://{APIConfig.Config.Address}:{APIConfig.Config.Port}");
